...
import OriginalAttachmentView from '@methods/attachment/view';
import StorageFactory from '@services/storage/factory';

const { default: View } = rewiremock.proxy<{
  default: typeof OriginalAttachmentView;
}>(() => require('@methods/attachment/view'), {
  typeorm: TypeormMock.mock,
});

describe('methods/attachment/view', () => {
