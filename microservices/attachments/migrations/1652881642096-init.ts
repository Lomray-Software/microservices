...
export default class init1652881642096 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "attachment_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "entityId" character varying(36) NOT NULL, "attachmentId" uuid NOT NULL, "type" character varying(30) NOT NULL, "microservice" character varying(50) NOT NULL, "order" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "attachment_entity(uq):entityId_attachmentId_microservice_type" UNIQUE ("entityId", "attachmentId", "microservice", "type"), CONSTRAINT "attachment_entity(pk):id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
