...
export default class init1645628476443 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."token_type_enum" NOT NULL, "userId" character varying(36) NOT NULL, "personal" character varying(32), "access" character varying(300), "refresh" character varying(300), "expirationAt" integer, "params" json NOT NULL DEFAULT '{}', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fc16f8ff67106143227c8658ea1" UNIQUE ("type", "userId", "personal", "access"), CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
