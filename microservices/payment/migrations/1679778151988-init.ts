...
export default class init1679778151988 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "transaction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "transactionId" character varying(66) NOT NULL, "title" character varying(66) NOT NULL, "customerId" character varying(18) NOT NULL, "bankAccountId" character varying(66) NOT NULL, "cardId" character varying(66) NOT NULL, "entityId" character varying(66) NOT NULL "amount" integer NOT NULL, "tax" integer NOT NULL, "fee" integer NOT NULL, "status" character varying(18) NOT NULL, "type" character varying(10) NOT NULL, "transactionStatus" character varying(18) NOT NULL, CONSTRAINT "transaction(pk):transactionId" PRIMARY KEY ("transactionId"))`,
    );
    await queryRunner.query(
