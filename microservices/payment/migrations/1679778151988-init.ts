...
export default class init1679778151988 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bank_account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "bank_account(pk):id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "card" ("cardId" character varying(29) NOT NULL, "userId" character varying(36) NOT NULL, "lastDigits" character varying(4) NOT NULL, "expired" character varying(5) NOT NULL, "holderName" character varying(100) NOT NULL DEFAULT '', "type" character varying(20) NOT NULL, "isDefault" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "card(pk):cardId" PRIMARY KEY ("cardId"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_card_userId" ON "card" ("userId") `);
    await queryRunner.query(
