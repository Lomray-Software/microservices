...
export default class init1645793882509 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "config" ("id" SERIAL NOT NULL, "microservice" character varying(50) NOT NULL, "type" character varying(30) NOT NULL, "params" json NOT NULL DEFAULT '{}', CONSTRAINT "UQ_323f96882b5330a0354a6ed0110" UNIQUE ("microservice", "type"), CONSTRAINT "PK_d0ee79a681413d50b0a4f98cf7b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
