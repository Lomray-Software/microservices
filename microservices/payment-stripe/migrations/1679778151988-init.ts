...
export default class init1679778151988 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "price" ("priceId" character varying(30) NOT NULL, "productId" character varying(19) NOT NULL, "userId" character varying(36) NOT NULL, "currency" character varying(10) NOT NULL, "unitAmount" integer NOT NULL, CONSTRAINT "price(pk):priceId" PRIMARY KEY ("priceId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bank_account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying(36) NOT NULL, "lastDigits" character varying(4) NOT NULL, "bankName" character varying(100), "holderName" character varying(100) NOT NULL DEFAULT '', "isDefault" boolean NOT NULL DEFAULT false, "isInstantPayoutAllowed" boolean NOT NULL DEFAULT false, "params" json NOT NULL DEFAULT '{}', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "bank_account(pk):id" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "card" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying(36) NOT NULL, "lastDigits" character varying(4) NOT NULL, "params" json NOT NULL DEFAULT '{}', "expired" character varying(5) NOT NULL, "holderName" character varying(100) NOT NULL DEFAULT '', "funding" character varying(10) NOT NULL, "brand" character varying(20) NOT NULL, "isDefault" boolean NOT NULL DEFAULT false, "isInstantPayoutAllowed" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "card(pk):id" PRIMARY KEY ("id"))`,
    );
